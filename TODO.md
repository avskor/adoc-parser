...
## Свежий baseline корпуса (2026-06-09, ПОСЛЕ attr-ref-link-macro)

`/mnt/c/tmp/adoc-test/` 344 файла: **Identical 180, Different 164, Errors 0**
...
Следующие чистые flip-кандидаты (по near-miss на 180):
...
не резолвится; п.36), **width.adoc** (`th` vs `td` — header-row из include + autowidth `~`).
