...
## Свежий baseline корпуса (2026-05-31, ПОСЛЕ escaped-char-reference)

`/mnt/c/tmp/adoc-test/` 344 файла: **Identical 145, Different 199, Errors 0**
...
Следующие чистые flip-кандидаты (по near-miss): escaped-директива `\ifdef`/`\endif`
(admonitions, inter-document-xref — preprocessor-слой, ~2 flip'а), xref-id норм.
