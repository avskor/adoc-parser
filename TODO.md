...
## Свежий baseline корпуса (2026-06-09, ПОСЛЕ rowspan-row-placement)

`/mnt/c/tmp/adoc-test/` 344 файла: **Identical 203, Different 141, Errors 0** (после
rowspan-row-placement; `python3 compare_full.py`, release-бинарь). **COMPAT-DIFF.md
устарел** (числа от 2026-03-23).
Следующие near-miss-кандидаты (на 203): **pass/index** (6-diff — остаток `` `+pass:[]+` `` через
...
ТЕКСТЕ xref-ссылки — архитектурный QUOTES в `[label]`).
