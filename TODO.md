...
## Свежий baseline корпуса (2026-06-09, ПОСЛЕ literal-paragraph-block-title)

`/mnt/c/tmp/adoc-test/` 344 файла: **Identical 198, Different 146, Errors 0** (после
gate-experimental-ui-macros; `python3 compare_full.py`, release-бинарь). **COMPAT-DIFF.md устарел**
(числа от 2026-03-23).
