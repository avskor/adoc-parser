...
**Рекомендация:** F-A/F-B/F-G/F-J/F-D/F-C/F-K/F-F/F-E/F-I/F-H — ЗАКРЫТЫ. Дальше: **F-J'**
(`:compat-mode:` → `:language:` алиасит `:source-language:`) либо follow-up'ы F-H (`skip-front-matter`,
inline `***`/`___`).
