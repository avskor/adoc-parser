...
## Свежий baseline корпуса (2026-06-09, ПОСЛЕ macro-text-replacements)

`/mnt/c/tmp/adoc-test/` 344 файла: **Identical 168, Different 176, Errors 0**
...
**custom caption на админишене** `[caption="Work in Progress"]` (glossary), **неизвестный
verbatim-style → class** `[plantuml]` на literal-блоке (monitoring — остаток п.40-смежное),
**kbd `+`-разделитель** `kbd:[key(+key)*]` (keyboard-macro). Архитектурные (отложены):
