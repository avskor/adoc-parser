...
## Свежий baseline корпуса (2026-06-09, ПОСЛЕ attr-ref-path-before-brackets)

`/mnt/c/tmp/adoc-test/` 344 файла: **Identical 186, Different 158, Errors 0**
...
Следующие чистые flip-кандидаты (по near-miss на 186):
...
document_attrs). Далее 4-diff кластеры (не разведаны): role.adoc, user-index.adoc, text/index.adoc.
Прежнее смежное `{url}/path[text]` ЗАКРЫТО (ветка `fix/attr-ref-path-before-brackets`, см. ниже).
