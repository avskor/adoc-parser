...
## Свежий baseline корпуса (2026-06-09, ПОСЛЕ callout-item-block-and-shifted-source-lang)

`/mnt/c/tmp/adoc-test/` 344 файла: **Identical 202, Different 142, Errors 0** (после
callout-item-block-and-shifted-source-lang; `python3 compare_full.py`, release-бинарь). **COMPAT-DIFF.md
устарел** (числа от 2026-03-23).
Следующие near-miss-кандидаты (на 202): **pass/index** (6-diff — остаток `` `+pass:[]+` `` через
