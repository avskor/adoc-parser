...
**Рекомендация:** F-A/F-B/F-G/F-J/F-D/F-C/F-K — ЗАКРЫТЫ. Дальше: **F-F** (`menu:X[]` → `<b class="menuref">`)
→ F-E (`[%nowrap]`) / F-I (UTF-8 BOM) / F-H (YAML front matter) / F-J' (`:compat-mode:` → `:language:`).
